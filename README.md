...
​	本程序是以当下流行的**电商**为范本，基于**C/S框架**的简单模拟程序，其本身远不具有日常使用的能力和商业价值，但可以作为一个简单的小项目供初学者学习。
...
- ##### 微商系统的大致功能
  ...
  - ###### Client端
    ...
    包含了登陆、注册 、货物商品推荐、促销活动、客服信息、购物车操作、购买记录操作、聊天操作、商品搜索、搜索记录的记录与商品购买。除此之外还有其他附加小功能，会在报告中阐述。
...
- ##### 本程序设计的知识技术和学习路线以及大致规划
  ...
  2. 学习数据库方面内容
     ...
     - 简单了解数据库(本程序选择的是mysql，网上有许多的博客介绍数据库，只需要简单了解其关键术语，基本使用方法即可)。[<1天]
  ...
  3. 学习java相关内容
     ...
     - 通过百度、google、各网站博客来了解java语言、学习编译环境的搭建、学习相关编译器的使用。这里IDE推荐intellij IDEA 2020，网上有专门的破解教程和安装方法。
  ...
  5. 尝试运行本程序
     ...
     2. 数据库下载最新的即可，应该没有太大问题，导入数据表可以通过navicat进行导入，网上有具体教程，不在过多阐述。
